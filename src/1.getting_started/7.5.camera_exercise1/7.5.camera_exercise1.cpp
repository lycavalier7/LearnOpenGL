...
void ProcessInput(GLFWwindow* pWindow)
{
	...
	{
		camera.ProcessKeyBorad(CameraMovement::FORWARD, deltaTime);
	}
	else if (glfwGetKey(pWindow, GLFW_KEY_S) == GLFW_PRESS)
	{
		camera.ProcessKeyBorad(CameraMovement::BACK, deltaTime);
	}
	else if (glfwGetKey(pWindow, GLFW_KEY_A) == GLFW_PRESS)
	{
		camera.ProcessKeyBorad(CameraMovement::LEFT, deltaTime);
	}
	else if (glfwGetKey(pWindow, GLFW_KEY_D) == GLFW_PRESS)
	{
		camera.ProcessKeyBorad(CameraMovement::RIGHT, deltaTime);
	}
}
...
int main()
{
	...
	glfwSetScrollCallback(pWindow, ScollCallback);
	...
	Shader shader("7.5.camera_exercise1.vs", "7.5.camera_exercise1.fs");
